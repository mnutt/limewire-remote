...
# map.with_options(:path_prefix => 'cloud')

# Map a controller and action to respond to /cloud
plugin_map.root :controller => 'cloud', :action => 'index'

# Like mapping ':controller/:action', this catches most things
plugin_map.cloud ':action/:id', :controller => 'cloud'

# Add this route to point to your widget action if you want to display a widget on the homepage
# plugin_map.widget "/widget", :controller => 'cloud', :action => 'widget'
