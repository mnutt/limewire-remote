...
// DCT: modified for mouseover vs. click
function addInfoWindowToMarker(marker,info,options){
	GEvent.addListener(marker, "mouseover", function() {marker.openInfoWindowHtml(info,options);});
	return marker;
}

// DCT: modified for mouseover vs. click
function addInfoWindowTabsToMarker(marker,info,options){
     GEvent.addListener(marker, "mouseover", function() {marker.openInfoWindowTabsHtml(info,options);});
     return marker;
}
